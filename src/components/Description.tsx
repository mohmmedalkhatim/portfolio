    ...
    <section className="md:px-[7rem]  flex flex-col relative">
      <div className="flex flex-col md:flex-row gap-11">
        <p className="text-justify  text-lg w-full lg:p-12 lg:w-[80%] ">
          specialized in web frontend alongside desktop application with react
          and tauri, I like focusing my effort to build an interactive ui with a
          perfect user experience, my main skills set is problem solving and ui
          development, I have the knowledge and technical skills to build an api
          in both languages rust and type-script, and I have the knowledge to
